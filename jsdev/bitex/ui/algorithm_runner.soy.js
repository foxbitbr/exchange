...
bitex.ui.AlgorithmRunner.templates.AlgorithmRunner = function(opt_data) {
  ...
  output += '<form id="' + soy.$$escapeHtml(opt_data.id) + '_form" class="algo-runner form-horizontal well" data-uniform-control-holder-class="control-group" ><legend>' + soy.$$escapeHtml(opt_data.algorithmDefinition['description']) + '</legend><div class="control-group" style=""><label class="control-label">' + MSG_UNNAMED_79 + '</label><div class="controls"><label id="' + soy.$$escapeHtml(opt_data.id) + '" class="control-label" style="text-align: left;">' + soy.$$escapeHtml(opt_data.symbol.symbol) + '</label></div></div>';
  ...
  for (var fieldIndex15 = 0; fieldIndex15 < fieldListLen15; fieldIndex15++) {
    ...
    output += '<div class="control-group"><label class="control-label">' + soy.$$escapeHtml(fieldData15['label']) + '</label><div class="controls"><input class="algo-runner-field"' + ((fieldData15['validator']) ? ' data-uniform-validators="' + soy.$$escapeHtml(fieldData15['validator']) + '" ' : '') + ((fieldData15['filter']) ? ' data-uniform-filters="' + soy.$$escapeHtml(fieldData15['filter']) + '" ' : '') + 'type="' + soy.$$escapeHtml(fieldData15['type']) + '" name="' + soy.$$escapeHtml(fieldData15['name']) + '" label="' + ((fieldData15['placeholder']) ? soy.$$escapeHtml(fieldData15['placeholder']) : '') + '" value="' + ((fieldData15['value']) ? soy.$$escapeHtml(fieldData15['value']) : '') + '" /></div></div>';
  }
