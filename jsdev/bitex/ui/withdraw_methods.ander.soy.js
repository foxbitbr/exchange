// This file was automatically generated from withdraw_methods.ander.soy.
...
bitex.ui.withdraw_methods.templates.WithdrawMethods = function(opt_data) {
  ...
  output += '</tbody></table><div class="withdraw-methods-show-when-dirty-state"><button class="btn btn--positive withdraw-methods-action-save">' + MSG_UNNAMED_98 + '</button><button class="btn btn--negative withdraw-methods-action-cancel">' + MSG_UNNAMED_100 + '</button></div><div class="withdraw-methods-show-when-clean-state"><a class="btn btn--primary dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-white icon-plus"></i> ' + MSG_UNNAMED_102 + '</a><ul class="dropdown-menu">';
